...
try:
    from mda_simulator import __version__ as release
except ImportError:
    release = "unknown"
...
project = "mda_simulator"
copyright = "2022, Ian Hunt-Isaak, John Russell"
...
def linkcode_resolve(domain, info):
    ...
    fn = os.path.relpath(fn, start=os.path.dirname("../mda_simulator"))

    return f"https://github.com/ianhi/mda-simulator/blob/main/mda_simulator/{fn}{linespec}"  # noqa
